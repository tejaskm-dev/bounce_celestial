...
const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'combo',    name: 'Unbroken',         desc: 'Hold a x10 combo',                   glyph: '∞', value: s => s.bestCombo,     goal: 10 },
  ...
  { id: 'score',    name: 'Ascendant',        desc: 'Score 2,500 in a run',               glyph: '★', value: s => s.bestScore,     goal: 2500 },
  ...
  { id: 'combo30',  name: 'Metronome',        desc: 'Hold a x15 combo',                   glyph: '◈', value: s => s.bestCombo,     goal: 15 },
  ...
  { id: 'score10k', name: 'Rising Star',      desc: 'Score 1,500 in a run',               glyph: '✩', value: s => s.bestScore,     goal: 1500 },
  { id: 'score200k',name: 'Empyrean',         desc: 'Score 4,000 in a run',               glyph: '✵', value: s => s.bestScore,     goal: 4000 },
